...
class ChatReadRetrieveReadApproach(Approach):
    ...
    system_message_chat_conversation = """User persona is {userPersona} Answer with the facts listed in the list of sources below in {query_term_language} with citations. If there isn't enough information below, please ask the user to rephrase and do not give citations. For tabular information return it as an html table. Do not return markdown format. 
    ...
    -If you cannot find an answer in below sources first ask the user to rephrase  
    -If you still cannot find an answer in below sources after asking the user to rephrase, provide an educated answer that lets the user know the answer IS NOT GROUNDED IN SOURCE MATERIAL. 
